...
var ValidationTypes_1 = require("./types/ValidationTypes");
var MetadataStorage_1 = require("./metadata/MetadataStorage");
var ValidationTypes_2 = require("./types/ValidationTypes");
...
var Validator = (function () {
     ...
     */
    Validator.prototype.validate = function (object, validationOptions) {
        var _this = this;
        var groups = validationOptions ? validationOptions.groups : undefined;
            ...
            if (nestedValidation) {
                if (value instanceof Array) {
                    value.map(function (v) {
                        var nestedErrors = _this.validate(v, validationOptions);
                        if (nestedErrors && nestedErrors.length)
                            errors = errors.concat(nestedErrors);
                    });
                }
                else if (value instanceof Object) {
                    var nestedErrors = _this.validate(value, validationOptions);
                    if (nestedErrors && nestedErrors.length)
                        errors = errors.concat(nestedErrors);
                }
                else {
     ...
     */
    Validator.prototype.validateAsync = function (object, validationOptions) {
        var _this = this;
        return new Promise(function (ok, fail) {
            var errors = _this.validate(object, validationOptions);
            if (errors.length > 0) {
     ...
     */
    Validator.prototype.validateOrThrow = function (object, validationOptions) {
        var errors = this.validate(object, validationOptions);
        if (errors.length > 0)
     ...
     */
    Validator.prototype.sanitize = function (object) {
        var _this = this;
     ...
     * Performs in async-style, useful to use it in chained promises.
     */
    Validator.prototype.sanitizeAsync = function (object) {
        var _this = this;
     ...
     */
    Validator.prototype.sanitizeAndValidate = function (object, validationOptions) {
     ...
     * Performs in async-style, useful to use it in chained promises.
     */
    Validator.prototype.sanitizeAndValidateAsync = function (object, validationOptions) {
        var _this = this;
        return new Promise(function (ok, fail) {
            var errors = _this.sanitizeAndValidate(object, validationOptions);
            if (errors.length > 0) {
                fail(new ValidationError_1.ValidationError(errors));
            }
            else {
     ...
     */
    Validator.prototype.isValid = function (object, validationOptions) {
    ...
    Validator.prototype.blacklist = function (str, chars) {
        return validatatorJs.blacklist(str, chars);
    };
    /**
     * Replace <, >, &, ', " and / with HTML entities.
     */
    Validator.prototype.escape = function (str) {
        return validatatorJs.escape(str);
    };
    /**
     * Trim characters from the left-side of the input.
     */
    Validator.prototype.ltrim = function (str, chars) {
        return validatatorJs.ltrim(str, chars.join());
    };
    /**
     * Canonicalize an email address.
     */
    Validator.prototype.normalizeEmail = function (str, lowercase) {
        return validatatorJs.normalizeEmail(str, lowercase);
    };
    /**
     * Trim characters from the right-side of the input.
     */
    Validator.prototype.rtrim = function (str, chars) {
     ...
     */
    Validator.prototype.stripLow = function (str, keepNewLines) {
     ...
     */
    Validator.prototype.toBoolean = function (input, isStrict) {
        return validatatorJs.toBoolean(input, isStrict);
    };
    /**
     * Convert the input to a date, or null if the input is not a date.
     */
    Validator.prototype.toDate = function (input) {
        return validatatorJs.toDate(input);
    };
    /**
     * Convert the input to a float.
     */
    Validator.prototype.toFloat = function (input) {
        return validatatorJs.toFloat(input);
    };
    /**
     * Convert the input to an integer, or NaN if the input is not an integer.
     */
    Validator.prototype.toInt = function (input, radix) {
        return validatatorJs.toInt(input, radix);
    };
    /**
     * Convert the input to a string.
     */
    Validator.prototype.toString = function (input) {
     ...
     */
    Validator.prototype.trim = function (str, chars) {
        return validatatorJs.trim(str, chars.join());
    };
    Validator.prototype.whitelist = function (str, chars) {
    ...
    Validator.prototype.sanitizeValue = function (value, metadata) {
        var _this = this;
        switch (metadata.type) {
            ...
            case SanitizeTypes_1.SanitizeTypes.CUSTOM_SANITIZATION:
                return this.metadataStorage
                    ...
                    if (!validatorMetadata.instance)
                        validatorMetadata.instance = _this.createInstance(validatorMetadata.object);
                    return validatorMetadata.instance;
                }).reduce(function (result, validator) { return validator.sanitize(result); }, value);
            default:
