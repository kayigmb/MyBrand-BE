...
var MetadataStorage = (function () {
    ...
    MetadataStorage.prototype.getValidationMetadatasForObject = function (object, groups) {
        return this.validationMetadatas
            .filter(function (metadata) { return metadata.object.constructor === object && metadata.sanitize === false; })
     ...
     */
    MetadataStorage.prototype.getSanitizeMetadatasForObject = function (object) {
        return this.validationMetadatas.filter(function (metadata) { return metadata.object.constructor === object && metadata.sanitize === true; });
    };
    /**
     * Gets all validator constraints for the given object.
     */
    MetadataStorage.prototype.getValidatorConstraintsForObject = function (object) {
        return this.constraintMetadatas.filter(function (metadata) { return metadata.object === object && metadata.sanitize === false; });
    };
    /**
    ...
    MetadataStorage.prototype.getSanitizeConstraintsForObject = function (object) {
        return this.constraintMetadatas.filter(function (metadata) { return metadata.object === object && metadata.sanitize === true; });
    };
